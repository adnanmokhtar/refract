...
- `templates/packs/` — pack catalog (20 tracks including `ai-engineering`, `algorithms`, `align`, `migration`, and `learning`, 110 commands, 61 agents) + per-track `_essentials.md` manifests
