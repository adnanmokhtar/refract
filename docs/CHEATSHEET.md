...
| `/ui-audit` | The design team in one command — the visual sibling of /audit. | `--plan`, `--scope=<path>`, `--reimagine`, `--max-parallel=<N>`, `--first-run`, `--tier=<V0\|V1\|V2\|V3>`, `--re-scan` | `/ui-audit --plan` |
