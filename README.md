...
[![Commands](https://img.shields.io/badge/commands-153-orange.svg)](#the-commands)
...
Another 137 commands ship inside the packs and install per-project when their pack is selected.
...
| **89 agents** | Specialised reviewers and architects |
| **118 skills** | Reusable procedures, as `<name>/SKILL.md` |
