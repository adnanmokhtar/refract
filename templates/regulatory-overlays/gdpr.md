...
- Pair with **`iso-27001.md`** if doing formal infosec governance — significant control overlap.
- Pair with **`ccpa.md`** if also serving California users — similar but distinct regime.
