...
The pack provides twelve commands and three critical skills:
...
- `/ui-audit` → `.claude/commands/ui-audit.md` (reuses the Playwright MCP, the `creative-director` agent and the 19-verb skill; no new native surface)
