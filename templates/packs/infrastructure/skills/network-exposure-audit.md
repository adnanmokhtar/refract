...
description: Audit cloud + K8s network exposure across the running/declared footprint. Every ingress path must be intentional and least-exposed — no wide-open ingress without a documented reason.
---
