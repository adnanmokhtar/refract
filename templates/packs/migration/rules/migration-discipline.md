...
## Per-feature audit — 12 hard halts

The audit step runs against an implementation + its artifacts. The audit HALTS (refuses to advance the feature) on any of these 12 conditions:
