...
CI-side: a migration linter blocks unsafe migrations; slow-query logging on in dev + staging; backups automated and the **restore** tested on a schedule — an untested backup does not exist.
