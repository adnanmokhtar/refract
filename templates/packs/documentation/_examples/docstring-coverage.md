...
description: Detect exported / public API symbols missing a contract docstring — functions, classes, modules, endpoints, exported types — and optionally gate on a coverage threshold. A docstring states WHY / the contract, not a restated signature.
---
