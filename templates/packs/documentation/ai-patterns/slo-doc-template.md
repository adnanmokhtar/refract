...
description: "Pattern: the SLO DOCUMENT template — how an SLO is written down (statement, why-this-target, exclusions, owner, breach runbook). Complements observability/slo.md, which owns the error-budget arithmetic and burn-rate alerting."
kind: ai-pattern
pack: documentation
---
