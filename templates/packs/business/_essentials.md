...
essentials:
  agents: [business-analyst, business-auditor]
...
- **agents**: `business-analyst` writes specs from rough ideas; `business-auditor` walks shipped features for completeness gaps.
