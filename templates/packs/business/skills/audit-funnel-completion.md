---
description: Walk a user-facing flow as each role and report drop-off opportunities, missing instrumentation, error-path gaps, and the single highest-leverage fix to lift completion rate.
---
